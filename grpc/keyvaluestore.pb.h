...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_keyvaluestore_2eproto 
...
class Request : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:keyvaluestore.Request) */ {
 public:
  Request();
  virtual ~Request();
 ...
 private:
  ...
  friend struct ::protobuf_keyvaluestore_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class Response : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:keyvaluestore.Response) */ {
 public:
  Response();
  virtual ~Response();
